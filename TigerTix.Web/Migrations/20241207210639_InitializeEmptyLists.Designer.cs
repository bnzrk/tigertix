...
namespace TigerTix.Web.Migrations
{
    ...
    [Migration("20241207210639_InitializeEmptyLists")]
    partial class InitializeEmptyLists
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TigerTix.Web.Data.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TigerTix.Web.Data.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TigerTix.Web.Data.Entities.Order", b =>
                {
                    b.HasOne("TigerTix.Web.Data.Entities.ApplicationUser", "User")
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TigerTix.Web.Data.Entities.Ticket", b =>
                {
                    ...
                    b.HasOne("TigerTix.Web.Data.Entities.Order", null)
                        .WithMany("Tickets")
